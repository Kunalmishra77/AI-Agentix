...
export const capabilities = {
  ...
  items: [
    { title: 'Agentic AI Solutions', tagline: 'AI Agents That Work While You Sleep',
    ...
    { title: 'End-to-End Automation', tagline: 'Connect Every Tool. Eliminate Every Bottleneck.',
    ...
    { title: 'AI Content Studio', tagline: 'Scale Content Without Scaling Headcount',
    ...
    { title: 'Voice AI Agents', tagline: '24/7 Voice Agents That Sound Human',
    ...
    { title: 'Finance Automation', tagline: 'Zero-Error Finance Ops on Autopilot',
    ...
    { title: 'Data Intelligence', tagline: 'From Raw Data to Revenue Decisions',
...
export const solutions = {
  ...
  items: [
    { name: 'AI Sales Agent', tagline: 'Never Miss a Lead Again',
    ...
    { name: 'AI Customer Support', tagline: 'Support at Scale, Zero Burnout',
    ...
    { name: 'AI Content Engine', tagline: 'Content Factory on Autopilot',
    ...
    { name: 'Business Intelligence', tagline: 'Real-Time Decisions, Not Gut Feels',
    ...
    { name: 'HR & Ops Automation', tagline: 'Ops That Run Without You',
    ...
    { name: 'E-commerce Automation', tagline: 'Scale Orders, Not Overheads',
    ...
    { name: 'Voice AI Agents', tagline: 'Calls Answered. Leads Captured. 24/7.',
    ...
    { name: 'Finance & GST Automation', tagline: 'Finance Ops Without the Errors',
    ...
    { name: 'WhatsApp Marketing', tagline: 'Your Best Salesperson Runs on WhatsApp',
