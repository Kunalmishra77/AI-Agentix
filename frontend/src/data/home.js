...
export const capabilities = {
  ...
  items: [
    ...
    { title: 'End-to-End Automation', image: '/images/crm-sync.webp', tagline: 'Connect Every Tool. Eliminate Every Bottleneck.',
    ...
    { title: 'AI Content Studio', image: '/images/content-studio.webp', tagline: 'Scale Content Without Scaling Headcount',
    ...
    { title: 'Voice AI Agents', image: '/images/voice-agent.webp', tagline: '24/7 Voice Agents That Sound Human',
    ...
    { title: 'Finance Automation', image: '/images/finance-gst.webp', tagline: 'Zero-Error Finance Ops on Autopilot',
    ...
    { title: 'Data Intelligence', image: '/images/analytics-bi.webp', tagline: 'From Raw Data to Revenue Decisions',
...
export const solutions = {
  ...
  items: [
    { name: 'AI Sales Agent', image: '/images/sales-agent.webp', tagline: 'Never Miss a Lead Again',
    ...
    { name: 'AI Customer Support', image: '/images/customer-support.webp', tagline: 'Support at Scale, Zero Burnout',
    ...
    { name: 'AI Content Engine', image: '/images/content-engine.webp', tagline: 'Content Factory on Autopilot',
    ...
    { name: 'Business Intelligence', image: '/images/business-intelligence.webp', tagline: 'Real-Time Decisions, Not Gut Feels',
    ...
    { name: 'HR & Ops Automation', image: '/images/hr-ops.webp', tagline: 'Ops That Run Without You',
    ...
    { name: 'E-commerce Automation', image: '/images/ecommerce.webp', tagline: 'Scale Orders, Not Overheads',
    ...
    { name: 'Voice AI Agents', image: '/images/voice-agent.webp', tagline: 'Calls Answered. Leads Captured. 24/7.',
    ...
    { name: 'Finance & GST Automation', image: '/images/finance-gst.webp', tagline: 'Finance Ops Without the Errors',
    ...
    { name: 'WhatsApp Marketing', image: '/images/whatsapp-marketing.webp', tagline: 'Your Best Salesperson Runs on WhatsApp',
...
export const industries = {
  ...
  items: [
    { name: 'Real Estate', image: '/images/ind-real-estate.webp', stat: '4.2x ROI', to: '/industries/real-estate', desc: 'Lead nurturing & property recommendation AI' },
    { name: 'Healthcare', image: '/images/ind-healthcare.webp', stat: '70% less admin', to: '/industries/healthcare', desc: 'Appointment bots, patient follow-up & billing AI' },
    { name: 'Education', image: '/images/ind-education.webp', stat: '3x enrollments', to: '/industries/education', desc: 'Admissions automation & student engagement' },
    { name: 'Retail & E-com', image: '/images/ind-retail.webp', stat: '28% more orders', to: '/industries/retail-ecommerce', desc: 'Personalisation, returns & inventory automation' },
    { name: 'Logistics', image: '/images/ind-logistics.webp', stat: '50% faster ops', to: '/industries/logistics', desc: 'Route optimisation & delivery status automation' },
    { name: 'Hospitality', image: '/images/ind-hospitality.webp', stat: '92% satisfaction', to: '/industries/hospitality', desc: 'Booking management & guest experience AI' },
    { name: 'Manufacturing', image: '/images/ind-manufacturing.webp', stat: '35% cost cut', to: '/industries/manufacturing', desc: 'Shop-floor AI, defect detection & OEE tracking' },
  ],
}
...
export const caseStudies = {
  ...
  items: [
    { client: 'PropTech Startup, Mumbai', industry: 'Real Estate', image: '/images/case-real-estate.webp',
    ...
    { client: 'D2C Brand, Bengaluru', industry: 'E-commerce', image: '/images/case-ecommerce.webp',
    ...
    { client: 'Multi-Specialty Clinic Chain, New Delhi', industry: 'Healthcare', image: '/images/case-healthcare.webp',
    ...
    { client: 'CBSE Day School (2,400 Students), Pune', industry: 'Education', image: '/images/case-education.webp',
    ...
    { client: 'Last-Mile Delivery Company, Delhi NCR', industry: 'Logistics', image: '/images/case-logistics.webp',
    ...
    { client: 'Boutique Hotel Chain (12 Properties), Rajasthan', industry: 'Hospitality', image: '/images/case-hospitality.webp',
    ...
    { client: 'Auto Components Manufacturer, Pune', industry: 'Manufacturing', image: '/images/case-manufacturing.webp',
