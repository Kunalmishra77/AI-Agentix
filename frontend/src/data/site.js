...
export const aboutMega = {
  ...
  items: [
    { label: 'Our Mission', to: '/about#mission', desc: 'Democratize AI for India’s 63 Million Businesses' },
    { label: 'Our Journey', to: '/about#journey', desc: 'Built Fast. Shipped Real. Year One.' },
    { label: 'Our Values', to: '/about#values', desc: 'Principles We Never Compromise On' },
    { label: 'Why We’re Different', to: '/about#different', desc: 'What Sets Our Work Apart' },
