...
export default {
  ...
  capabilities: {
    ...
    items: [
      { name: 'Lead Qualification AI', image: '/images/lead-scoring.webp', icon: 'target',
      ...
      { name: 'Multi-Channel Outreach', image: '/images/omnichannel.webp', icon: 'send',
      ...
      { name: 'Pipeline Intelligence', image: '/images/analytics-bi.webp', icon: 'pipeline',
      ...
      { name: 'CRM Auto-Enrichment', image: '/images/crm-sync.webp', icon: 'enrich',
      ...
      { name: 'Meeting Booking', image: '/images/scheduling.webp', icon: 'calendar',
      ...
      { name: 'Revenue Analytics', image: '/images/analytics-bi.webp', icon: 'analytics',
