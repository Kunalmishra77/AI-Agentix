...
export default {
  ...
  capabilities: {
    ...
    items: [
      { name: 'Lead Qualification AI', icon: 'target', image: '/AGENTIX-MEDIAS/leadcaptured.webp',
      ...
      { name: 'Multi-Channel Outreach', icon: 'send', image: '/AGENTIX-MEDIAS/calling.webp',
      ...
      { name: 'Pipeline Intelligence', icon: 'pipeline', image: '/AGENTIX-MEDIAS/progress-tracked.webp',
      ...
      { name: 'CRM Auto-Enrichment', icon: 'enrich', image: '/AGENTIX-MEDIAS/CRM.webp',
      ...
      { name: 'Meeting Booking', icon: 'calendar', image: '/AGENTIX-MEDIAS/aiagent.webp',
      ...
      { name: 'Revenue Analytics', icon: 'analytics', image: '/AGENTIX-MEDIAS/growthamplified.webp',
