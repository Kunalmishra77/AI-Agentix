...
export default {
  ...
  capabilities: {
    ...
    items: [
      { name: 'Production Planning AI', image: '/images/forecasting.webp', icon: 'calendar',
      ...
      { name: 'Quality Control Automation', image: '/images/quality-vision.webp', icon: 'approval',
      ...
      { name: 'Predictive Maintenance', image: '/images/predictive-maintenance.webp', icon: 'maintenance',
      ...
      { name: 'Inventory & BOM Management', image: '/images/inventory.webp', icon: 'inventory',
      ...
      { name: 'OEE & Efficiency Analytics', image: '/images/analytics-bi.webp', icon: 'analytics',
      ...
      { name: 'ERP & MES Integration', image: '/images/crm-sync.webp', icon: 'integration',
