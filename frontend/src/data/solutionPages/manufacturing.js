...
export default {
  ...
  capabilities: {
    ...
    items: [
      { name: 'Production Planning AI', icon: 'calendar',
      ...
      { name: 'Quality Control Automation', icon: 'approval',
      ...
      { name: 'Predictive Maintenance', icon: 'maintenance',
      ...
      { name: 'Inventory & BOM Management', icon: 'inventory',
      ...
      { name: 'OEE & Efficiency Analytics', icon: 'analytics',
      ...
      { name: 'ERP & MES Integration', icon: 'integration',
