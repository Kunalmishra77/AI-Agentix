...
export default {
  ...
  capabilities: {
    ...
    items: [
      { name: 'Content Engine', image: '/images/content-engine.webp', icon: 'content',
      ...
      { name: 'Campaign Manager', image: '/images/marketing-campaigns.webp', icon: 'campaign',
      ...
      { name: 'Lead Nurturing', image: '/images/lead-scoring.webp', icon: 'nurture',
      ...
      { name: 'Analytics & ROI', image: '/images/analytics-bi.webp', icon: 'analytics',
      ...
      { name: 'SEO Intelligence', image: '/images/content-engine.webp', icon: 'seo',
