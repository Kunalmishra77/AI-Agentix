...
export default {
  ...
  capabilities: {
    ...
    items: [
      { name: 'Content Engine', icon: 'content', image: '/AGENTIX-MEDIAS/WEBSITE.webp',
      ...
      { name: 'Campaign Manager', icon: 'campaign', image: '/AGENTIX-MEDIAS/customerconverted.webp',
      ...
      { name: 'Lead Nurturing', icon: 'nurture', image: '/AGENTIX-MEDIAS/MAILING.webp',
      ...
      { name: 'Analytics & ROI', icon: 'analytics', image: '/AGENTIX-MEDIAS/data analyst.webp',
      ...
      { name: 'SEO Intelligence', icon: 'seo', image: '/AGENTIX-MEDIAS/Customer RESEARCH agent.webp',
