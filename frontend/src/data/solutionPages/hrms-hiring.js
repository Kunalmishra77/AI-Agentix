...
export default {
  ...
  capabilities: {
    ...
    items: [
      { name: 'AI Candidate Screening', icon: 'screen', image: '/AGENTIX-MEDIAS/Customer RESEARCH agent.webp',
      ...
      { name: 'Interview Automation', icon: 'interview', image: '/AGENTIX-MEDIAS/calling.webp',
      ...
      { name: 'Onboarding Workflows', icon: 'onboard', image: '/AGENTIX-MEDIAS/Harshita - Onboarding.webp',
      ...
      { name: 'Performance Management', icon: 'analytics', image: '/AGENTIX-MEDIAS/data analyst.webp',
      ...
      { name: 'Payroll & Compliance', icon: 'finance', image: '/AGENTIX-MEDIAS/Amit-Renewal Agent.webp',
      ...
      { name: 'Employee Engagement', icon: 'engage', image: '/AGENTIX-MEDIAS/MAILING.webp',
