...
export default {
  ...
  capabilities: {
    ...
    items: [
      { name: 'AI Candidate Screening', image: '/images/hr-recruitment.webp', icon: 'screen',
      ...
      { name: 'Interview Automation', image: '/images/business-intelligence.webp', icon: 'interview',
      ...
      { name: 'Onboarding Workflows', image: '/images/hr-recruitment.webp', icon: 'onboard',
      ...
      { name: 'Performance Management', image: '/images/document-ocr.webp', icon: 'analytics',
      ...
      { name: 'Payroll & Compliance', image: '/images/finance-gst.webp', icon: 'finance',
      ...
      { name: 'Employee Engagement', image: '/images/hr-recruitment.webp', icon: 'engage',
