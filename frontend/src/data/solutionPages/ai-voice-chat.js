...
export default {
  ...
  heroImage: '/AGENTIX-MEDIAS/aiagent.webp',
  hero: {
  ...
  capabilities: {
    ...
    items: [
      { name: 'Natural Language Understanding', icon: 'bot', image: '/AGENTIX-MEDIAS/Customer RESEARCH agent.webp',
      ...
      { name: 'Multi-Language Support', icon: 'language', image: '/AGENTIX-MEDIAS/wp.webp',
      ...
      { name: 'Lead Qualification Engine', icon: 'target', image: '/AGENTIX-MEDIAS/leadcaptured.webp',
      ...
      { name: 'Human Escalation', icon: 'escalate', image: '/AGENTIX-MEDIAS/Customer Support.webp',
      ...
      { name: 'CRM Integration', icon: 'enrich', image: '/AGENTIX-MEDIAS/CRM.webp',
      ...
      { name: 'Analytics & Optimization', icon: 'analytics', image: '/AGENTIX-MEDIAS/data analyst.webp',
