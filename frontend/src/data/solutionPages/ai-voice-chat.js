...
export default {
  ...
  capabilities: {
    ...
    items: [
      { name: 'Natural Language Understanding', icon: 'bot',
      ...
      { name: 'Multi-Language Support', icon: 'language',
      ...
      { name: 'Lead Qualification Engine', icon: 'target',
      ...
      { name: 'Human Escalation', icon: 'escalate',
      ...
      { name: 'CRM Integration', icon: 'enrich',
      ...
      { name: 'Analytics & Optimization', icon: 'analytics',
