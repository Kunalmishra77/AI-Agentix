...
export default {
  ...
  capabilities: {
    ...
    items: [
      { name: 'Invoice Automation', image: '/images/finance-billing.webp', icon: 'invoice',
      ...
      { name: 'Expense Management', image: '/images/finance-gst.webp', icon: 'expense',
      ...
      { name: 'Accounts Receivable AI', image: '/images/finance-gst.webp', icon: 'receivable',
      ...
      { name: 'Statutory Compliance', image: '/images/compliance-security.webp', icon: 'approval',
      ...
      { name: 'Cash Flow Intelligence', image: '/images/analytics-bi.webp', icon: 'forecast',
      ...
      { name: 'Financial Reporting', image: '/images/analytics-bi.webp', icon: 'analytics',
