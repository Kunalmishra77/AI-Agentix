...
export default {
  ...
  heroImage: '/AGENTIX-MEDIAS/img-123.webp',
  hero: {
  ...
  capabilities: {
    ...
    items: [
      { name: 'Invoice Automation', icon: 'invoice', image: '/AGENTIX-MEDIAS/CRM.webp',
      ...
      { name: 'Expense Management', icon: 'expense', image: '/AGENTIX-MEDIAS/MAILING.webp',
      ...
      { name: 'Accounts Receivable AI', icon: 'receivable', image: '/AGENTIX-MEDIAS/Amit-Renewal Agent.webp',
      ...
      { name: 'Statutory Compliance', icon: 'approval', image: '/AGENTIX-MEDIAS/renewalsecured.webp',
      ...
      { name: 'Cash Flow Intelligence', icon: 'forecast', image: '/AGENTIX-MEDIAS/data analyst.webp',
      ...
      { name: 'Financial Reporting', icon: 'analytics', image: '/AGENTIX-MEDIAS/Customer RESEARCH agent.webp',
