...
export default {
  ...
  heroImage: '/AGENTIX-MEDIAS/progress-tracked.webp',
  hero: {
  ...
  capabilities: {
    ...
    items: [
      { name: 'Workflow Orchestration', icon: 'workflow', image: '/AGENTIX-MEDIAS/Customer RESEARCH agent.webp',
      ...
      { name: 'Document Intelligence', icon: 'document', image: '/AGENTIX-MEDIAS/CRM.webp',
      ...
      { name: 'Approval Engine', icon: 'approval', image: '/AGENTIX-MEDIAS/renewalsecured.webp',
      ...
      { name: 'Ops Analytics', icon: 'analytics', image: '/AGENTIX-MEDIAS/data analyst.webp',
      ...
      { name: 'Exception Management', icon: 'alert', image: '/AGENTIX-MEDIAS/Customer Support.webp',
      ...
      { name: 'Integration Fabric', icon: 'integration', image: '/AGENTIX-MEDIAS/leadcaptured.webp',
