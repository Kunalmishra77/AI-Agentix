...
export default {
  ...
  capabilities: {
    ...
    items: [
      { name: 'Workflow Orchestration', image: '/images/workflow-automation.webp', icon: 'workflow',
      ...
      { name: 'Document Intelligence', image: '/images/document-ocr.webp', icon: 'document',
      ...
      { name: 'Approval Engine', image: '/images/business-intelligence.webp', icon: 'approval',
      ...
      { name: 'Ops Analytics', image: '/images/analytics-bi.webp', icon: 'analytics',
      ...
      { name: 'Exception Management', image: '/images/business-intelligence.webp', icon: 'alert',
      ...
      { name: 'Integration Fabric', image: '/images/crm-sync.webp', icon: 'integration',
