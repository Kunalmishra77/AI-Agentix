...
export default {
  ...
  capabilities: {
    ...
    items: [
      { name: 'Demand Forecasting AI', icon: 'forecast', image: '/AGENTIX-MEDIAS/data analyst.webp',
      ...
      { name: 'Inventory Intelligence', icon: 'inventory', image: '/AGENTIX-MEDIAS/CRM.webp',
      ...
      { name: 'Vendor Management', icon: 'users', image: '/AGENTIX-MEDIAS/Amit-Renewal Agent.webp',
      ...
      { name: 'Logistics Optimization', icon: 'truck', image: '/AGENTIX-MEDIAS/progress-tracked.webp',
      ...
      { name: 'Supply Chain Analytics', icon: 'analytics', image: '/AGENTIX-MEDIAS/Customer RESEARCH agent.webp',
      ...
      { name: 'Risk & Disruption Alerts', icon: 'alert', image: '/AGENTIX-MEDIAS/renewalsecured.webp',
