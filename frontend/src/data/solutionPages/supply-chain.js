...
export default {
  ...
  capabilities: {
    ...
    items: [
      { name: 'Demand Forecasting AI', image: '/images/forecasting.webp', icon: 'forecast',
      ...
      { name: 'Inventory Intelligence', image: '/images/inventory.webp', icon: 'inventory',
      ...
      { name: 'Vendor Management', image: '/images/business-intelligence.webp', icon: 'users',
      ...
      { name: 'Logistics Optimization', image: '/images/logistics-fleet.webp', icon: 'truck',
      ...
      { name: 'Supply Chain Analytics', image: '/images/analytics-bi.webp', icon: 'analytics',
      ...
      { name: 'Risk & Disruption Alerts', image: '/images/compliance-security.webp', icon: 'alert',
