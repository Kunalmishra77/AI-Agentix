...
export default {
  ...
  capabilities: {
    ...
    items: [
      { name: 'Patient Scheduling & OPD Automation', image: '/images/scheduling.webp', icon: 'calendar',
      ...
      { name: 'EMR / EHR Integration & Auto-Filing', image: '/images/crm-sync.webp', icon: 'enrich',
      ...
      { name: 'Billing & Insurance Claims AI', image: '/images/finance-billing.webp', icon: 'invoice',
      ...
      { name: 'Lab & Pharmacy Management', image: '/images/inventory.webp', icon: 'health',
      ...
      { name: 'Staff Scheduling & HR Automation', image: '/images/scheduling.webp', icon: 'users',
      ...
      { name: 'Patient Communication & Follow-Up', image: '/images/chat-support.webp', icon: 'chat',
