...
export default {
  ...
  capabilities: {
    ...
    items: [
      { name: 'Patient Scheduling & OPD Automation', icon: 'calendar', image: '/AGENTIX-MEDIAS/calling.webp',
      ...
      { name: 'EMR / EHR Integration & Auto-Filing', icon: 'enrich', image: '/AGENTIX-MEDIAS/CRM.webp',
      ...
      { name: 'Billing & Insurance Claims AI', icon: 'invoice', image: '/AGENTIX-MEDIAS/Amit-Renewal Agent.webp',
      ...
      { name: 'Lab & Pharmacy Management', icon: 'health', image: '/AGENTIX-MEDIAS/MAILING.webp',
      ...
      { name: 'Staff Scheduling & HR Automation', icon: 'users', image: '/AGENTIX-MEDIAS/Harshita - Onboarding.webp',
      ...
      { name: 'Patient Communication & Follow-Up', icon: 'chat', image: '/AGENTIX-MEDIAS/Customer Support.webp',
