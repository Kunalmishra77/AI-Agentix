...
export default {
  ...
  heroImage: '/AGENTIX-MEDIAS/growthamplified.webp',
  hero: {
  ...
  solutions: {
    ...
    items: [
      { name: 'Conversational Commerce', image: '/AGENTIX-MEDIAS/wp.webp',
      ...
      { name: 'Personalized Recommendations', image: '/AGENTIX-MEDIAS/data analyst.webp',
      ...
      { name: 'Cart Abandonment Recovery', image: '/AGENTIX-MEDIAS/MAILING.webp',
      ...
      { name: 'Customer Support Automation', image: '/AGENTIX-MEDIAS/Customer Support.webp',
      ...
      { name: 'Inventory Intelligence', image: '/AGENTIX-MEDIAS/CRM.webp',
      ...
      { name: 'Loyalty & Retention Engine', image: '/AGENTIX-MEDIAS/Customer RESEARCH agent.webp',
