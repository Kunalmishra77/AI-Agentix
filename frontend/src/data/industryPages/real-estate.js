...
export default {
  ...
  solutions: {
    ...
    items: [
      { name: 'Lead Qualification Engine', image: '/AGENTIX-MEDIAS/Customer RESEARCH agent.webp',
      ...
      { name: 'Property Matching AI', image: '/AGENTIX-MEDIAS/data analyst.webp',
      ...
      { name: 'Site Visit Automation', image: '/AGENTIX-MEDIAS/calling.webp',
      ...
      { name: 'Document Processing', image: '/AGENTIX-MEDIAS/CRM.webp',
      ...
      { name: 'Post-Sale Relationship', image: '/AGENTIX-MEDIAS/MAILING.webp',
      ...
      { name: 'Market Intelligence', image: '/AGENTIX-MEDIAS/progress-tracked.webp',
