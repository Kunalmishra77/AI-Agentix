...
export default {
  ...
  solutions: {
    ...
    items: [
      { name: 'Predictive Maintenance', image: '/AGENTIX-MEDIAS/data analyst.webp',
      ...
      { name: 'Quality Defect Detection', image: '/AGENTIX-MEDIAS/renewalsecured.webp',
      ...
      { name: 'Production Scheduling AI', image: '/AGENTIX-MEDIAS/Amit-Renewal Agent.webp',
      ...
      { name: 'Supply Chain Automation', image: '/AGENTIX-MEDIAS/leadcaptured.webp',
      ...
      { name: 'Energy Optimization', image: '/AGENTIX-MEDIAS/CRM.webp',
      ...
      { name: 'Worker Safety Monitoring', image: '/AGENTIX-MEDIAS/Customer Support.webp',
