...
export default {
  ...
  solutions: {
    ...
    items: [
      { name: 'Route Optimization AI', image: '/images/logistics-fleet.webp',
      ...
      { name: 'Shipment Tracking Automation', image: '/images/logistics-fleet.webp',
      ...
      { name: 'Warehouse Intelligence', image: '/images/inventory.webp',
      ...
      { name: 'Demand Forecasting', image: '/images/forecasting.webp',
      ...
      { name: 'Freight Rate Automation', image: '/images/business-intelligence.webp',
      ...
      { name: 'Customer Communication Hub', image: '/images/chat-support.webp',
