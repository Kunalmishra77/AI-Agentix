...
export default {
  ...
  solutions: {
    ...
    items: [
      { name: 'AI Appointment Management', image: '/AGENTIX-MEDIAS/calling.webp',
      ...
      { name: 'Patient Communication AI', image: '/AGENTIX-MEDIAS/MAILING.webp',
      ...
      { name: 'Medical Documentation AI', image: '/AGENTIX-MEDIAS/Customer RESEARCH agent.webp',
      ...
      { name: 'Revenue Cycle Automation', image: '/AGENTIX-MEDIAS/Amit-Renewal Agent.webp',
      ...
      { name: 'Inventory & Pharmacy AI', image: '/AGENTIX-MEDIAS/CRM.webp',
      ...
      { name: 'Staff & Scheduling', image: '/AGENTIX-MEDIAS/Harshita - Onboarding.webp',
