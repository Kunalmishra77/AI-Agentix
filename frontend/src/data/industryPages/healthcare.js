...
export default {
  ...
  solutions: {
    ...
    items: [
      { name: 'AI Appointment Management', image: '/images/scheduling.webp',
      ...
      { name: 'Patient Communication AI', image: '/images/chat-support.webp',
      ...
      { name: 'Medical Documentation AI', image: '/images/document-ocr.webp',
      ...
      { name: 'Revenue Cycle Automation', image: '/images/finance-billing.webp',
      ...
      { name: 'Inventory & Pharmacy AI', image: '/images/inventory.webp',
      ...
      { name: 'Staff & Scheduling', image: '/images/scheduling.webp',
