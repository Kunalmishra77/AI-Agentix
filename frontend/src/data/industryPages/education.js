...
export default {
  ...
  heroImage: '/AGENTIX-MEDIAS/img.webp',
  hero: {
  ...
  solutions: {
    ...
    items: [
      { name: 'AI Admissions Automation', image: '/AGENTIX-MEDIAS/calling.webp',
      ...
      { name: 'Student Support Chatbot', image: '/AGENTIX-MEDIAS/Customer Support.webp',
      ...
      { name: 'Learning Path Personalization', image: '/AGENTIX-MEDIAS/data analyst.webp',
      ...
      { name: 'Faculty Productivity Tools', image: '/AGENTIX-MEDIAS/Customer RESEARCH agent.webp',
      ...
      { name: 'Alumni Engagement Engine', image: '/AGENTIX-MEDIAS/MAILING.webp',
