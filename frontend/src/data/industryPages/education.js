...
export default {
  ...
  solutions: {
    ...
    items: [
      { name: 'AI Admissions Automation', image: '/images/business-intelligence.webp',
      ...
      { name: 'Student Support Chatbot', image: '/images/chat-support.webp',
      ...
      { name: 'Learning Path Personalization', image: '/images/personalization.webp',
      ...
      { name: 'Faculty Productivity Tools', image: '/images/business-intelligence.webp',
      ...
      { name: 'Alumni Engagement Engine', image: '/images/business-intelligence.webp',
