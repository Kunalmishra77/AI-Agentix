...
export default {
  ...
  solutions: {
    ...
    items: [
      { name: 'Reservation Automation', image: '/images/scheduling.webp',
      ...
      { name: 'Guest Experience Personalization', image: '/images/personalization.webp',
      ...
      { name: 'Concierge AI Assistant', image: '/images/chat-support.webp',
      ...
      { name: 'Housekeeping Optimization', image: '/images/business-intelligence.webp',
      ...
      { name: 'Revenue Management', image: '/images/sales-agent.webp',
      ...
      { name: 'Review & Reputation Management', image: '/images/business-intelligence.webp',
