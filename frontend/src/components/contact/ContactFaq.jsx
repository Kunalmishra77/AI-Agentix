...
import { faq, details } from '../../data/contact'
import { cn } from '../../lib/cn'

export default function ContactFaq() {
  const [open, setOpen] = useState(0)
  return (
    <Section tone="alt" id="faq" className="scroll-mt-20">
      <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:gap-14">
        ...
        <div className="lg:sticky lg:top-28 lg:self-start">
          ...
          <div className="mt-8 overflow-hidden rounded-2xl bg-gradient-to-br from-accent to-accent-hover p-6 text-white">
            ...
            <h3 className="mt-4 text-lg font-bold">Prefer to chat?</h3>
            <p className="mt-1.5 text-sm leading-relaxed text-white/90">WhatsApp us and get a real answer in minutes — during business hours.</p>
            <a href={details.whatsapp} target="_blank" rel="noreferrer" className="btn mt-5 bg-white text-accent hover:bg-white/90">
