    ...
    <>
      ...
      >
        <div className="max-w-[1240px] mx-auto w-full px-4 sm:px-8 lg:px-12 h-full flex items-center gap-4">
          ...
          <ul className="hidden lg:flex flex-1 items-center justify-between text-sm pl-4 xl:pl-10">
            ...
            <li>
              <Link to="/case-studies" className={`px-2 xl:px-3.5 py-2 font-semibold uppercase tracking-wide text-[11px] xl:text-[12px] transition-colors ${linkColor}`}>
                Case Studies
              </Link>
            </li>

            <li>
              <Link to="/careers" className={`px-2 xl:px-3.5 py-2 font-semibold uppercase tracking-wide text-[11px] xl:text-[12px] transition-colors ${linkColor}`}>
                Career
              </Link>
            </li>
          </ul>
          ...
          <Link to="/contact"
            className="hidden lg:inline-flex items-center shrink-0 px-4 xl:px-5 py-2.5 bg-[#F26522] text-white font-display font-bold text-[12px] xl:text-sm rounded-lg hover:bg-[#FF7A3D] transition-colors">
            Let's talk
          </Link>
