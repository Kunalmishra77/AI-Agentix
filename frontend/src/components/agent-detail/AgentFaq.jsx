...
// Premium FAQ — same visual language as the rest of the site (consistency was a
// hard requirement): sticky heading + help card on the left, numbered accordion right.
export default function AgentFaq({ agent }) {
    ...
    <Section tone="white" id="faq" className="scroll-mt-20">
      <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:gap-14">
        <div className="lg:sticky lg:top-28 lg:self-start">
          ...
          <h2 className="text-h2 text-heading">Questions about the {agent.name}</h2>
          <div className="relative mt-7 overflow-hidden rounded-2xl bg-ink p-6">
            ...
            <p className="mt-2 text-sm leading-relaxed text-ink-muted">Talk to an engineer — we'll map exactly how the {agent.name} fits your workflows.</p>
